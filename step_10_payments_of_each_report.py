...
def run_step_10():
    logging.info("Починаю виконувати step_10: payments of each report")
    ...
    df.to_csv(
        "output/step_10_payments_of_each_report.csv",
        index=False,
        encoding="utf-8-sig"
    )
    ...
    logging.info("Дані про звіти збережено у step_10_payments_of_each_report.csv")
